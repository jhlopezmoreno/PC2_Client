 ...
 * USAGE:
 * <pre>
 *        UpdateStudentClient client = new UpdateStudentClient();
...
public class UpdateStudentClient {
    ...
    public static void main(String args[])throws UniformInterfaceException {
        ...
        CreateStudentClient client1=new CreateStudentClient();
        ClientResponse response1= client1.find_XML(ClientResponse.class,"9");
        GenericType<Students> genericType = new GenericType<Students>() {};
        
        Students studentss=response1.getEntity(genericType);
        ...
        System.out.println("Birthday:  "+studentss.getBirthday());
        System.out.println("-----------");
        
        studentss.setLastname("DIAZ DIAZ");
